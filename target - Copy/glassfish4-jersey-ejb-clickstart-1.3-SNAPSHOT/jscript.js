...
$(document)
        .ready(
                function() {
                                    ...
                                    function() {
                                        ...
                                        $
                                                .ajax({
                                                    ...
                                                    success : function(data,
                                                            status, response) {
                                                        var tmp = response.responseText; // THIS
                                                        // IS
                                                        // THE
                                                        // TRICK
                                                        renderSingleXml(tmp);
                    ...
                    $('#ajaxformgetAll').submit(function(e) {
                        $('#countryList').remove();
                        var formURL = $(this).attr("action");
                        $.ajax({
                            url : formURL,
                    ...
                    $('#xmlbutton').on('click', function() {
                        ...
                        $.ajax({
                            ...
                            success : function(data, status, response) {
                                var tmp = response.responseText; // THIS IS
                                // THE TRICK
                                renderXml(tmp);
                            },
                            error : function(jqXHR, textStatus, errorThrown) {
